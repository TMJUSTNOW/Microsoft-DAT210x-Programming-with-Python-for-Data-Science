...
def do_RandomizedPCA(armadillo):
  ...
  pca = RandomizedPCA(copy=True, iterated_power=2, n_components=2,
...
for i in range(nb_iterations): pca = do_PCA(armadillo)
...
t1 = datetime.datetime.now()
for i in range(nb_iterations): rpca = do_RandomizedPCA(armadillo)
time_delta = datetime.datetime.now() - t1
